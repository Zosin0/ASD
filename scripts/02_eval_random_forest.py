...
from models.random_forest_model import predict_application_state
...
def test_model():
    ...
    test_data_fail = google[google['event'] == 'FAIL'][['scheduling_class', 'priority', 'assigned_memory', 'average_usage_memory', 'maximum_usage_memory', 'resource_request_memory', 'cycles_per_instruction', 'memory_accesses_per_instruction']].head(3)
    test_data_success = google[google['event'] == 'FINISH'][['scheduling_class', 'priority', 'assigned_memory', 'average_usage_memory', 'maximum_usage_memory', 'resource_request_memory', 'cycles_per_instruction', 'memory_accesses_per_instruction']].head(3)
